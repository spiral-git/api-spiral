...
class ProductoBasicoController extends BaseController
{
    private UsuarioService $_usuarioService;
    private ProductoBasicoService $_service;

    private TipoUsuarioService $_tipoUsuarioService;


    public function __construct(UsuarioService $usuarioService, TipoUsuarioService $tipoUsuarioService, ProductoBasicoService $service)
    {
    ...
    {
        $dto = new ProductoBasicoInputDto();
